...
const en: Dict = {
  ...
  uploadCurrentFile: "Upload images in current note",
...
const ko: Dict = {
  ...
  uploadCurrentFile: "현재 노트의 이미지 업로드",
...
const ja: Dict = {
  ...
  uploadCurrentFile: "現在のノートの画像をアップロード",
